// Ruta: ctp-docente-portal.Server/Data/AppDbContext.cs
// (sin cambios funcionales, lo muestro para que confirmes)
...
namespace ctp_docente_portal.Server.Data
{
  public class AppDbContext : DbContext
  {
    ...
    public DbSet<SectionsModel> Sections { get; set; } = null!;
  }
}
