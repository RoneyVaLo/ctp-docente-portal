...
const SelectContent = React.forwardRef((props, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "absolute z-50 max-h-96 min-w-[8rem] w-full overflow-hidden rounded-md bg-popover text-popover-foreground shadow-md bg-slate-300/80 dark:bg-slate-400/60 backdrop-blur-sm dark:backdrop-blur-sm",
